...
#define APP_USART_RX_BUFFER_SIZE          10 		/* Receive buffer size for USART. */
#define APP_USART_TX_BUFFER_SIZE          300		/* Transmit buffer size for USART */
...
// #define CS_CHANNEL_MASK 0x3FFFC00L
#define CS_CHANNEL_MASK 0x00030000L
...
//-----------------------------------------------
  ...
  #define CS_APS_MAX_BLOCKS_AMOUNT 12
...
/*
  ...
  APP_DELAY_BEFORE_SEND, ms
    ...
    A value of 0 means no dealy is needed.
*/
// #define APP_TRANSMISSION_DELAY            0//20

#if APP_FRAGMENTATION
  #define  APP_MAX_PACKET_SIZE            1139
  ...
  #define  APP_MAX_PACKET_SIZE            APS_MAX_ASDU_SIZE-1 //60
  #define  APP_DELAY_BEFORE_SEND          0
